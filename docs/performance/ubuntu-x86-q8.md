...
- `qa/evidence-bundles/llamacpp-q8-cpu-re-20260514T1200Z/artifacts/cron-5e4b0b83-20260521T2155Z-docs-support-contract-host-audit/README.md` (docs support-contract/host-reporting audit: historical validation notes now use evidence-status wording instead of host-load status, guarded support wording remained exact-row/default-off scoped, public scrub, public evidence-claim, and diff checks passed, and remote validation was not attempted in this run)
