...
- `qa/evidence-bundles/llamacpp-q8-cpu-re-20260514T1200Z/artifacts/cron-0719640b-20260523T0334Z-ffndown-decode-chunking-plan/README.md` (default-off FFN-down decode group-chunking planner guard; canonical Ubuntu SSH timed out with exact rc/stderr recorded, so no cargo, timing, throughput, or llama.cpp parity claim)
