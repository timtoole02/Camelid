...
- `qa/evidence-bundles/llamacpp-q8-cpu-re-20260514T1200Z/artifacts/cron-95495a91-20260523T0222Z-ffndown-vnni-rawptr/README.md` (default-off Ubuntu/Linux x86_64 FFN-down VNNI rawptr same-host check; marker parity and route-use passed, but rawptr remains rejected for throughput promotion because llama.cpp was still faster and rawptr did not improve recorded VNNI kernel time in this bounded sample)
