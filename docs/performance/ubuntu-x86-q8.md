...
- `qa/evidence-bundles/llamacpp-q8-cpu-re-20260514T1200Z/artifacts/cron-5e4b0b83-20260521T1235Z-docs-support-contract-host-audit/README.md` (docs support-contract/host-reporting audit: stale host-failure and stale validation-lane scans passed, guarded support wording remained exact-row/default-off scoped, public scrub and diff checks passed, and remote validation was not attempted in this run)
- `qa/evidence-bundles/llamacpp-q8-cpu-re-20260514T1200Z/artifacts/cron-5e4b0b83-20260521T1515Z-docs-support-contract-host-audit/README.md` (docs support-contract/host-reporting audit: stale host-failure and stale validation-lane scans passed, guarded support wording remained exact-row/default-off scoped, public scrub, public evidence-claim, and diff checks passed, prior raw-pattern audit summaries were neutralized, and remote validation was not attempted in this run)
- `qa/evidence-bundles/llamacpp-q8-cpu-re-20260514T1200Z/artifacts/cron-5e4b0b83-20260521T1728Z-docs-support-contract-host-audit/README.md` (docs support-contract/host-reporting audit: public docs/context stale host-status scan passed, one historical validation-host rustfmt note was neutralized, guarded support wording remained exact-row/default-off scoped, public scrub, public evidence-claim, and diff checks passed, and remote validation was not attempted in this run)
- `qa/evidence-bundles/llamacpp-q8-cpu-re-20260514T1200Z/artifacts/cron-5e4b0b83-20260521T1926Z-docs-support-contract-host-audit/README.md` (docs support-contract/host-reporting audit: public docs/context and evidence-summary host-reporting wording was reviewed, guarded support wording remained exact-row/default-off scoped, public scrub, public evidence-claim, and diff checks passed, and remote validation was not attempted in this run)
- `qa/evidence-bundles/llamacpp-q8-cpu-re-20260514T1200Z/artifacts/cron-5e4b0b83-20260521T2155Z-docs-support-contract-host-audit/README.md` (docs support-contract/host-reporting audit: historical validation notes now use evidence-status wording instead of validation-lane capacity status, guarded support wording remained exact-row/default-off scoped, public scrub, public evidence-claim, and diff checks passed, and remote validation was not attempted in this run)
- `qa/evidence-bundles/llamacpp-q8-cpu-re-20260514T1200Z/artifacts/cron-5e4b0b83-20260521T2358Z-docs-support-contract-host-audit/README.md` (docs support-contract/host-reporting audit: public docs/context, retained audit summaries, and evidence-summary host-reporting wording were reviewed, guarded support wording remained exact-row/default-off scoped, public scrub, public evidence-claim, and diff checks passed, and remote validation was not attempted in this run)
- `qa/evidence-bundles/llamacpp-q8-cpu-re-20260514T1200Z/artifacts/cron-5e4b0b83-20260522T0519Z-docs-support-contract-host-hygiene/README.md` (docs support-contract/host-reporting hygiene: historical evidence-summary host-access wording and public scrub canonical-probe allowlist were aligned, guarded support wording remained exact-row/default-off scoped, public scrub, public evidence-claim, and diff checks passed, and remote validation was not attempted in this run)
- `qa/evidence-bundles/llamacpp-q8-cpu-re-20260514T1200Z/artifacts/cron-5e4b0b83-20260522T0737Z-docs-support-contract-host-audit/README.md` (docs support-contract/host-reporting audit: refined stale host-failure scan passed, guarded support wording remained exact-row/default-off scoped, public scrub, public evidence-claim, and diff checks passed, and remote validation was not attempted in this run)
- `qa/evidence-bundles/llamacpp-q8-cpu-re-20260514T1200Z/artifacts/cron-5e4b0b83-20260522T1014Z-docs-support-contract-host-audit/README.md` (docs support-contract/host-reporting audit: older scan summaries that repeated stale validation-lane status phrases inside regex text were neutralized, refreshed stale host-status and retired-host scans passed, guarded support wording remained exact-row/default-off scoped, public scrub, public evidence-claim, and diff checks passed, and remote validation was not attempted in this run)
- `qa/evidence-bundles/llamacpp-q8-cpu-re-20260514T1200Z/artifacts/cron-5e4b0b83-20260522T1315Z-docs-support-contract-host-audit/README.md` (docs support-contract/host-reporting audit: retained evidence summaries and command transcripts were neutralized where they carried raw stale host-status search text, refreshed host-status and retired-host scans passed, guarded support wording remained exact-row/default-off scoped, public scrub, public evidence-claim, and diff checks passed, and remote validation was not attempted in this run)
- `qa/evidence-bundles/llamacpp-q8-cpu-re-20260514T1200Z/artifacts/cron-5e4b0b83-20260522T1635Z-docs-support-contract-host-audit/README.md` (docs support-contract/host-reporting audit: refined host-status and retired-host scans passed, guarded support wording remained exact-row/default-off scoped, public scrub, public evidence-claim, and diff checks passed, and remote validation was not attempted in this run)
- `qa/evidence-bundles/llamacpp-q8-cpu-re-20260514T1200Z/artifacts/cron-5e4b0b83-20260522T2003Z-docs-support-contract-host-audit/README.md` (docs support-contract/host-reporting audit: refined host-status and retired-host scans passed, guarded support wording remained exact-row/default-off scoped, public scrub, public evidence-claim, and diff checks passed, and remote validation was not attempted in this run)
- `qa/evidence-bundles/llamacpp-q8-cpu-re-20260514T1200Z/artifacts/cron-5e4b0b83-20260522T2156Z-docs-support-contract-host-audit/README.md` (docs support-contract/host-reporting audit: refined host-status and retired-host scans passed, guarded support wording remained exact-row/default-off scoped, public scrub, public evidence-claim, and diff checks passed, and remote validation was not attempted in this run)
- `qa/evidence-bundles/llamacpp-q8-cpu-re-20260514T1200Z/artifacts/cron-5e4b0b83-20260523T0101Z-docs-support-contract-host-audit/README.md` (docs support-contract/host-reporting audit: word-bound host-status, retired-host, and raw SSH auth-failure phrase scans passed, guarded support wording remained exact-row/default-off scoped, public scrub, public evidence-claim, and diff checks passed, and remote validation was not attempted in this run)
- `qa/evidence-bundles/llamacpp-q8-cpu-re-20260514T1200Z/artifacts/cron-5e4b0b83-20260523T0351Z-docs-support-contract-host-audit/README.md` (docs support-contract/host-reporting audit: refined host-status, retired-host, and raw SSH auth-failure phrase scans passed, one prior raw scan transcript line was neutralized, guarded support wording remained exact-row/default-off scoped, public scrub, public evidence-claim, and diff checks passed, and remote validation was not attempted in this run)
