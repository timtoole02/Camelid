...
> use [`COMPATIBILITY.md`](../../COMPATIBILITY.md), [`STATUS.md`](../reference/STATUS.md), and the owner matrix in
> [`FULL_SUPPORT_BLOCKER_MATRIX.md`](../archive/campaigns/FULL_SUPPORT_BLOCKER_MATRIX.md).
