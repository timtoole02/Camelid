...
- Adaptive context sizing is implemented from validated/model limits and a
  concurrent-slot share of conservative live-memory capacity, but still lacks
  population-level calibration under latency and memory pressure.
