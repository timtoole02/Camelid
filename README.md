...
- **Llama 3.2 1B Instruct Q8_0** — verified bounded support at checked 512/1024/2048/4096/8192 contexts
...
- **Llama 3 8B Instruct Q8_0** — verified bounded support at checked 512/1024/2048 contexts
...
Camelid claims llama.cpp parity only for exact GGUF rows and envelopes with published validation evidence: TinyLlama at the current validated gate; Llama 3.2 1B Q8_0 with verified bounded support at checked 512/1024/2048/4096/8192-context packs; Llama 3.2 3B Q8_0 as supported exact-row smoke with canonical Ubuntu API/WebUI refresh, compact/broader parity, and checked 512/1024/2048-context packs; and Llama 3 8B Q8_0 with verified bounded support through checked 512/1024/2048-context packs tied to cited source/runtime-head bundles.
...
| Llama 3 8B Instruct Q8_0 | **Verified bounded support** | Load, completions, chat completions, WebUI validation, compact parity, three-prompt 50-token parity, checked 512/1024/2048-context packs, compact chat-template-shapes pack, memory evidence, structured RSS/Q8 file-read counters, and lazy-Q8 hot-path measurements. |
