...
Tag status: the annotated `v0.1.0-rc1` tag is pushed and dereferences to `d9fb294f47e3ae80291f969499e2240c6cd640c3`. The release branch now contains post-rc1 QA repairs at `3001fa48e3d5fa41dbeca417dd511164a3bacc80` and status-only blocker documentation through `d6e99b74b8f40c4420fb20b6f96257a1ef01d5fd`; the rc1 tag has not been moved. Final `v0.1.0` remains Tim-approval gated.

## Gate Summary

Current status: branch-head validation passed locally again at `d6e99b74b8f40c4420fb20b6f96257a1ef01d5fd` after a post-rc1 frontend/README QA repair and later status-only documentation updates. The existing `v0.1.0-rc1` tag predates the repair, so Tim must decide whether to cut a new candidate, retag rc1, or keep rc1 as a known-pre-fix candidate.
