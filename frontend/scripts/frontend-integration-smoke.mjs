...
try {
  ...
  assert.match(blockedWrongArtifactMarkup, /<button class="primary-button composer-send-button"[^>]*disabled[^>]*>Send</, '3B composer send must stay disabled for a runtime-ready neighboring artifact')
