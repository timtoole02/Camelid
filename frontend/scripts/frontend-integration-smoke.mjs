...
try {
  ...
  assert.match(exactReadySystemMarkup, /Remaining support boundary:<\/b> model-native\/larger context beyond checked packs; production throughput; portability; durable repeated current-head bundles remain missing/, 'System selected exact-row evidence should show unresolved 3B support boundaries after filtering resolved template/Jinja caveats')
