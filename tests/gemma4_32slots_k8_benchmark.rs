...
fn test_genuine_gemma4_32slots_k8() {
    ...
    println!("==========================================================================================================");
    println!("GENUINE GEMMA 4 26B-A4B 32-SLOT/LAYER NO-THRASH BENCHMARK (K = 8, Top-N = 12)");
    println!("Budget: 32 slots/layer (3.21 GiB Metal resident, 2.0 GiB Page Cache)");
    println!("==========================================================================================================\n");
    ...
    println!(">>> RUNNING BENCHMARK ROUND (32 SLOTS/LAYER) <<<");
    ...
    println!("--------------------------------------------------------------------------------");
    println!("TRUE OUTER ROUND RECONCILED LEDGER (K = 8, 32 Slots/Layer, Top-N = 12)");
    println!("--------------------------------------------------------------------------------");
    println!(
