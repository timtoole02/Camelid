    ...
    for row in gemma4_rows(&body) {
        ...
        assert!(
            scope == "exact_row_smoke_only"
                ...
                || scope == "exact_row_distributed_or_catalog_windows_cuda_or_apple_m4_full_metal_ghost_moe_smoke_only"
                || scope == "exact_row_distributed_or_apple_m4_full_metal_ghost_moe_smoke_only"
