...
#[cfg(all(target_os = "macos", target_arch = "aarch64"))]
use q8_telemetry::{
    record_q8_schedule_activation_pack, record_q8_schedule_i8mm_single_projection_role_call,
...
fn x86_q8_attention_qkv_prefill_consumer_enabled() -> bool {
    ...
    #[cfg(not(test))]
    {
        static X86_Q8_ATTENTION_QKV_PREFILL_CONSUMER: std::sync::OnceLock<bool> =
...
fn x86_q8_packed_rows4_decode_rawptr_avx2_enabled() -> bool {
    ...
    #[cfg(not(test))]
    {
        static X86_Q8_PACKED_ROWS4_DECODE_RAWPTR_AVX2_ENABLED: std::sync::OnceLock<bool> =
            std::sync::OnceLock::new();
...
fn x86_q8_ffn_down_gemm4_row_group_min_input_groups() -> usize {
    ...
    #[cfg(not(test))]
    {
        static X86_Q8_FFN_DOWN_GEMM4_ROW_GROUP_MIN_INPUT_GROUPS_ONCE: std::sync::OnceLock<usize> =
            std::sync::OnceLock::new();
...
fn x86_q8_packed_rows4_matmul_groups_per_chunk() -> usize {
    ...
    #[cfg(not(test))]
    {
        static X86_Q8_PACKED_ROWS4_MATMUL_CHUNK_GROUPS: std::sync::OnceLock<usize> =
            std::sync::OnceLock::new();
...
fn x86_q8_parallel_matmul_input_quantize_enabled() -> bool {
    ...
    #[cfg(not(test))]
    {
        static X86_Q8_PARALLEL_INPUT_QUANTIZE: std::sync::OnceLock<bool> =
            std::sync::OnceLock::new();
...
fn x86_q8_kernel_avx2_enabled() -> bool {
    ...
    #[cfg(not(test))]
    {
        static X86_Q8_KERNEL_AVX2_ENABLED: std::sync::OnceLock<bool> = std::sync::OnceLock::new();
...
fn x86_q8_packed_rows4_avx2_dot_enabled() -> bool {
    ...
    #[cfg(not(test))]
    {
        static X86_Q8_PACKED_ROWS4_AVX2_DOT_ENABLED: std::sync::OnceLock<bool> =
            std::sync::OnceLock::new();
...
fn x86_q8_packed_rows4_avx512vnni_dpwssd_dot_enabled() -> bool {
    ...
    #[cfg(not(test))]
    {
        static X86_Q8_PACKED_ROWS4_AVX512VNNI_DPWSSD_DOT_ENABLED: std::sync::OnceLock<bool> =
            std::sync::OnceLock::new();
...
fn x86_q8_packed_rows4_avx512vnni_dpbusd_dot_enabled() -> bool {
    ...
    #[cfg(not(test))]
    {
        static X86_Q8_PACKED_ROWS4_AVX512VNNI_DPBUSD_DOT_ENABLED: std::sync::OnceLock<bool> =
            std::sync::OnceLock::new();
...
fn x86_q8_packed_rows4_avx2_dot_hoist_enabled() -> bool {
    ...
    #[cfg(not(test))]
    {
        static X86_Q8_PACKED_ROWS4_AVX2_DOT_HOIST_ENABLED: std::sync::OnceLock<bool> =
            std::sync::OnceLock::new();
...
fn x86_q8_packed_rows4_avx2_dot_decode_hoist_enabled() -> bool {
    ...
    #[cfg(not(test))]
    {
        static X86_Q8_PACKED_ROWS4_AVX2_DOT_DECODE_HOIST_ENABLED: std::sync::OnceLock<bool> =
            std::sync::OnceLock::new();
