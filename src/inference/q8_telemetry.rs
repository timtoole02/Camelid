...
fn q8_telemetry_env_enabled() -> bool {
    env::var(Q8_SCHEDULE_TELEMETRY_ENV)
        .map(|value| {
...
pub fn q8_schedule_telemetry_enabled() -> bool {
    #[cfg(test)]
    {
        q8_telemetry_env_enabled()
    }
    #[cfg(not(test))]
    *Q8_SCHED_TELEMETRY_ENABLED.get_or_init(q8_telemetry_env_enabled)
}
