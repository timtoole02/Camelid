...
<llama-cpp-worktree>/build/bin/libggml-cpu.so.0.12.0:     file format elf64-x86-64
...
000000000006c8d0 <void (anonymous namespace)::tinygemm_kernel_amx<block_q8_0, block_q8_0, float, 32, 0>(int, int, int, void const*, void const*, float*, int) [clone .constprop.0]>:
   ...
   6d4fc:	c5 fd 7f ba a0 01 00 	vmovdqa %ymm7,0x1a0(%rdx)
   6d503:	00
   6d504:	41 83 fc 0f          	cmp    $0xf,%r12d
   6d508:	75 26                	jne    6d530 <void (anonymous namespace)::tinygemm_kernel_amx<block_q8_0, block_q8_0, float, 32, 0>(int, int, int, void const*, void const*, float*, int) [clone .constprop.0]+0xc60>
   6d50a:	6b c7 0e             	imul   $0xe,%edi,%eax
   6d50d:	48 98                	cltq
   6d50f:	48 ff c0             	inc    %rax
   6d512:	48 6b c0 22          	imul   $0x22,%rax,%rax
   6d516:	48 01 f0             	add    %rsi,%rax
   6d519:	c4 a1 7e 6f 7c 28 02 	vmovdqu 0x2(%rax,%r13,1),%ymm7
   6d520:	c5 fd 7f ba c0 01 00 	vmovdqa %ymm7,0x1c0(%rdx)
   6d527:	00
   6d528:	c5 f8 77             	vzeroupper
   6d52b:	eb 06                	jmp    6d533 <void (anonymous namespace)::tinygemm_kernel_amx<block_q8_0, block_q8_0, float, 32, 0>(int, int, int, void const*, void const*, float*, int) [clone .constprop.0]+0xc63>
   6d52d:	0f 1f 00             	nopl   (%rax)
   6d530:	c5 f8 77             	vzeroupper
   6d533:	48 8d 3d 4e d9 0e 00 	lea    0xed94e(%rip),%rdi        # 15ae88 <_DYNAMIC+0x240>
   6d53a:	e8 01 7a fa ff       	call   14f40 <__tls_get_addr@plt>
   6d53f:	b9 20 00 00 00       	mov    $0x20,%ecx
   6d544:	48 05 00 b8 00 00    	add    $0xb800,%rax
   6d54a:	c4 e2 7b 4b 14 08    	tileloadd (%rax,%rcx,1),%tmm2
   6d550:	e9 27 f9 ff ff       	jmp    6ce7c <void (anonymous namespace)::tinygemm_kernel_amx<block_q8_0, block_q8_0, float, 32, 0>(int, int, int, void const*, void const*, float*, int) [clone .constprop.0]+0x5ac>
   6d555:	0f 1f 00             	nopl   (%rax)
   6d558:	4c 63 ac 24 30 04 00 	movslq 0x430(%rsp),%r13
   6d55f:	00
   6d560:	49 6b c5 22          	imul   $0x22,%r13,%rax
   6d564:	4d 8d 24 07          	lea    (%r15,%rax,1),%r12
   6d568:	48 8d 3d 19 d9 0e 00 	lea    0xed919(%rip),%rdi        # 15ae88 <_DYNAMIC+0x240>
   6d56f:	e8 cc 79 fa ff       	call   14f40 <__tls_get_addr@plt>
   6d574:	c4 c1 7e 6f 7c 24 02 	vmovdqu 0x2(%r12),%ymm7
   6d57b:	8b b4 24 c0 04 00 00 	mov    0x4c0(%rsp),%esi
   6d582:	48 8d 88 00 b8 00 00 	lea    0xb800(%rax),%rcx
   6d589:	c5 fd 7f b8 00 b8 00 	vmovdqa %ymm7,0xb800(%rax)
   6d590:	00
   6d591:	83 fe 01             	cmp    $0x1,%esi
   6d594:	0f 84 ce 01 00 00    	je     6d768 <void (anonymous namespace)::tinygemm_kernel_amx<block_q8_0, block_q8_0, float, 32, 0>(int, int, int, void const*, void const*, float*, int) [clone .constprop.0]+0xe98>
   6d59a:	48 8b 94 24 48 05 00 	mov    0x548(%rsp),%rdx
   6d5a1:	00
   6d5a2:	49 8d 44 15 00       	lea    0x0(%r13,%rdx,1),%rax
   6d5a7:	48 6b f8 22          	imul   $0x22,%rax,%rdi
   6d5ab:	c4 c1 7e 6f 74 3f 02 	vmovdqu 0x2(%r15,%rdi,1),%ymm6
   6d5b2:	c5 fd 7f 71 20       	vmovdqa %ymm6,0x20(%rcx)
   6d5b7:	83 fe 02             	cmp    $0x2,%esi
   6d5ba:	0f 84 a8 01 00 00    	je     6d768 <void (anonymous namespace)::tinygemm_kernel_amx<block_q8_0, block_q8_0, float, 32, 0>(int, int, int, void const*, void const*, float*, int) [clone .constprop.0]+0xe98>
   6d5c0:	48 8b bc 24 f8 03 00 	mov    0x3f8(%rsp),%rdi
   6d5c7:	00
   6d5c8:	49 01 fd             	add    %rdi,%r13
   6d5cb:	4d 6b ed 22          	imul   $0x22,%r13,%r13
   6d5cf:	c4 81 7e 6f 7c 2f 02 	vmovdqu 0x2(%r15,%r13,1),%ymm7
   6d5d6:	c5 fd 7f 79 40       	vmovdqa %ymm7,0x40(%rcx)
   6d5db:	83 fe 03             	cmp    $0x3,%esi
   6d5de:	0f 84 84 01 00 00    	je     6d768 <void (anonymous namespace)::tinygemm_kernel_amx<block_q8_0, block_q8_0, float, 32, 0>(int, int, int, void const*, void const*, float*, int) [clone .constprop.0]+0xe98>
   6d5e4:	48 8d 04 50          	lea    (%rax,%rdx,2),%rax
   6d5e8:	48 6b f8 22          	imul   $0x22,%rax,%rdi
   6d5ec:	c4 c1 7e 6f 6c 3f 02 	vmovdqu 0x2(%r15,%rdi,1),%ymm5
   6d5f3:	c5 fd 7f 69 60       	vmovdqa %ymm5,0x60(%rcx)
   6d5f8:	83 fe 04             	cmp    $0x4,%esi
   6d5fb:	0f 84 67 01 00 00    	je     6d768 <void (anonymous namespace)::tinygemm_kernel_amx<block_q8_0, block_q8_0, float, 32, 0>(int, int, int, void const*, void const*, float*, int) [clone .constprop.0]+0xe98>
   6d601:	48 01 d0             	add    %rdx,%rax
   6d604:	48 6b f8 22          	imul   $0x22,%rax,%rdi
   6d608:	c4 c1 7e 6f 64 3f 02 	vmovdqu 0x2(%r15,%rdi,1),%ymm4
   6d60f:	c5 fd 7f a1 80 00 00 	vmovdqa %ymm4,0x80(%rcx)
   6d616:	00
   6d617:	83 fe 05             	cmp    $0x5,%esi
   6d61a:	0f 84 48 01 00 00    	je     6d768 <void (anonymous namespace)::tinygemm_kernel_amx<block_q8_0, block_q8_0, float, 32, 0>(int, int, int, void const*, void const*, float*, int) [clone .constprop.0]+0xe98>
   6d620:	48 01 d0             	add    %rdx,%rax
   6d623:	48 6b f8 22          	imul   $0x22,%rax,%rdi
   6d627:	c4 c1 7e 6f 6c 3f 02 	vmovdqu 0x2(%r15,%rdi,1),%ymm5
   6d62e:	c5 fd 7f a9 a0 00 00 	vmovdqa %ymm5,0xa0(%rcx)
   6d635:	00
   6d636:	83 fe 06             	cmp    $0x6,%esi
   6d639:	0f 84 29 01 00 00    	je     6d768 <void (anonymous namespace)::tinygemm_kernel_amx<block_q8_0, block_q8_0, float, 32, 0>(int, int, int, void const*, void const*, float*, int) [clone .constprop.0]+0xe98>
   6d63f:	48 01 d0             	add    %rdx,%rax
   6d642:	48 6b f8 22          	imul   $0x22,%rax,%rdi
   6d646:	c4 c1 7e 6f 74 3f 02 	vmovdqu 0x2(%r15,%rdi,1),%ymm6
   6d64d:	c5                   	.byte 0xc5
   6d64e:	fd                   	std
   6d64f:	7f                   	.byte 0x7f
