# Docs support-contract and host-reporting audit - 2026-05-21T12:35Z
...
Commands run from the docs worktree at source head `6b0f154378b8`:
...
Focused outputs are preserved in `stale-host-scan.txt`, `stale-validation-lane-scan.txt`, `support-contract-guarded-scan.txt`, `public-scrub.txt`, `diff-check.txt`, and `green-checks.txt`.
