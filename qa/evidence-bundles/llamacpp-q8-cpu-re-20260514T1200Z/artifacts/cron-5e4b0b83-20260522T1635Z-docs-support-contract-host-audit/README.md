# Docs Support-Contract And Host-Reporting Audit - 2026-05-22T16:35Z
...
Commands ran from the docs worktree at source head `2c0c5d9`:
...
- The refined host-status wording scan returned no matches for stale negative canonical-host status wording.
- Retired Ubuntu host aliases and the disallowed key shorthand were absent from public docs/context/status and retained docs-room evidence summaries.
